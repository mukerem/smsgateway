...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('first_name', 'last_name', 'phone_number', 'email', 'password1', 'password2', 'role', 'register_date')
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('first_name', 'last_name', 'phone_number', 'email', 'password', 'is_active',  'role')
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ( 'email', 'phone_number', 'rating')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('first_name', 'last_name', 'email', 'password1', 'password2', 'phone_number', 'role', 'rating','register_date')}
        ),
    )
    search_fields = ('email',)
    ordering = ('first_name',)
